...
# KUBE_EXTERNALSIGNER_GRPC_ROOT="${KUBE_ROOT}/staging/src/k8s.io/apiserver/pkg/authentication/externalsigner/v1alpha1/"
KUBE_EXTERNALSIGNER_GRPC_ROOT="${KUBE_ROOT}/staging/src/k8s.io/client-go/plugin/pkg/client/auth/externalsigner/v1alpha1"
