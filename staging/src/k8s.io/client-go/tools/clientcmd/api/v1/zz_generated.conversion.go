...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Pkcs11Info)(nil), (*api.Pkcs11Info)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_Pkcs11Info_To_api_Pkcs11Info(a.(*Pkcs11Info), b.(*api.Pkcs11Info), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.Pkcs11Info)(nil), (*Pkcs11Info)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_Pkcs11Info_To_v1_Pkcs11Info(a.(*api.Pkcs11Info), b.(*Pkcs11Info), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_AuthInfo_To_api_AuthInfo(in *AuthInfo, out *api.AuthInfo, s conversion.Scope) error {
	...
	out.Pkcs11Info = (*api.Pkcs11Info)(unsafe.Pointer(in.Pkcs11Info))
	return nil
}
...
func autoConvert_api_AuthInfo_To_v1_AuthInfo(in *api.AuthInfo, out *AuthInfo, s conversion.Scope) error {
	...
	out.Pkcs11Info = (*Pkcs11Info)(unsafe.Pointer(in.Pkcs11Info))
	return nil
}
...
// Convert_v1_Pkcs11Info_To_api_Pkcs11Info is an autogenerated conversion function.
func Convert_v1_Pkcs11Info_To_api_Pkcs11Info(in *Pkcs11Info, out *api.Pkcs11Info, s conversion.Scope) error {
	return autoConvert_v1_Pkcs11Info_To_api_Pkcs11Info(in, out, s)
}
...
// Convert_api_Pkcs11Info_To_v1_Pkcs11Info is an autogenerated conversion function.
func Convert_api_Pkcs11Info_To_v1_Pkcs11Info(in *api.Pkcs11Info, out *Pkcs11Info, s conversion.Scope) error {
	return autoConvert_api_Pkcs11Info_To_v1_Pkcs11Info(in, out, s)
}
